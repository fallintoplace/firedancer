...
#ifndef HEADER_fd_src_discof_admin_generated_fd_admin_tile_seccomp_h
#define HEADER_fd_src_discof_admin_generated_fd_admin_tile_seccomp_h
...
static const uint sock_filter_policy_fd_admin_tile_instr_cnt = 16;

static void populate_sock_filter_policy_fd_admin_tile( ulong out_cnt, struct sock_filter out[ static 16 ], uint logfile_fd ) {
  FD_TEST( out_cnt >= 16 );
  struct sock_filter filter[16] = {
    /* validate architecture */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, ( offsetof( struct seccomp_data, arch ) )),
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, ARCH_NR, 0, /* RET_KILL_PROCESS */ 3 ),
    /* load syscall number */
...
#endif /* HEADER_fd_src_discof_admin_generated_fd_admin_tile_seccomp_h */
